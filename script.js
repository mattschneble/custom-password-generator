...
function writePassword() {
  ...
  //create a variable to hold the password generated by the above selections in an array
  var passwordLoop = [];

  //create a for loop to randomly choose characters based on the length and input types made by the user and generate a password
  for (var i = 0; i < passwordLength; i++) {
    var pickSelection = selection[Math.floor(Math.random() * selection.length)];
    passwordLoop.push(pickSelection);
  }

  //join the passwordLoop array and convert into a string
  var password = passwordLoop.join("");
